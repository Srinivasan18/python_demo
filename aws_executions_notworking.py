...
#region='awsqnc ec2 describe-regions --query "Regions[].RegionName" --output text --region eu-west-1'
region = 'aws --profile agqnc ec2 describe-regions --query Regions[].RegionName --output text --region eu-west-1'
#print ("region")
